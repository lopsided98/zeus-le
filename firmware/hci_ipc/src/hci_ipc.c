...
static void hci_ipc_recv(uint8_t *data, size_t len) {
...
static void rx_thread(void *p1, void *p2, void *p3) {
    ...
    while (1) {
        ...
        /* Give other threads a chance to run if rx_queue keeps getting
...
int hci_ipc_init(void) {
    ...
    /* Spawn the RX thread and start receiving commands and data from the
     * controller.
     */
