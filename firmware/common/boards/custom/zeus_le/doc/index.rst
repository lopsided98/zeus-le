...
zeus-le board is based on the Fanstel WT02C40C module, using the Nordic
Semiconductor nRF5340 ARM Cortex-M33 SoC.

The nRF5340 inside the WT02C40C module is a
...
The ``zeus_le/nrf5340/cpuapp`` build target provides support for the application
core on the nRF5340 SoC. The ``zeus_le/nrf5340/cpuapp`` build target provides
...
The `pcb` directory contains the board's schematic.

Hardware
********
- Synchronized audio recording board
...
- RGB LED with animation driver
- Pushbutton
- 1 USB-C connector for battery charging and communication
- BMDU connector for FW programing and UART communication

Supported Features
==================

The ``zeus_le_nrf5340/cpuapp`` board configuration supports the following
hardware features:
...
The ``zeus_le_nrf5340/cpunet`` board configuration supports the following
hardware features:
...
for a complete list of zeus-le board hardware features.
...
Applications built for the ``zeus_le/nrf5340/cpuapp`` board by
...
Applications for the ``zeus_le_nrf5340`` board configuration can be
built, flashed, and debugged in the usual way. See :ref:`build_an_application` and
:ref:`application_run` for more details on building and running.

.. note::
   Flashing and Debugging Zephyr onto the zeus_le_nrf5340 board
...
Use a USB to TTL converter to connect the computer and zeus_le_nrf5340
...
.. zephyr-app-commands::
   ...
   :board: zeus_le_nrf5340
   :goals: build flash

Debugging
=========

The ``zeus_le_nrf5340`` board does not have an on-board-J-Link debug IC,
